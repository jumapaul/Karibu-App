...
class HomeFragment() : Fragment() {
    ...
    override fun onCreateView(
        ...
        // karibuViewModel.saveFavorites(favoriteMealsItem)
        //   view?.let { it1 -> Snackbar.make(it1, "Added to cart", Snackbar.LENGTH_SHORT).show() }
    ...
    fun setUpFavoriteMealsRecycleview() {
        ...
        favoriteMealsAdapter.listener = {v, i, p ->
            ...
            karibuViewModel.addToCart(cartItem)
